...
import { SellerDemoToolbar } from './components/SellerDemoToolbar';
...
export default function App() {
  // Store Config state (allows sellers to test custom store name, phone, and branding)
  ...
  return (
    <div className="min-h-screen pb-20 sm:pb-0 bg-[#F7F6F2] text-[#111111] flex flex-col selection:bg-[#111111] selection:text-white">
      ...
      <SellerDemoToolbar
        ...
        onReset={() => setStoreConfig(defaultStoreConfig)}
      />
      ...
      {/* 4. Featured / Best-selling jerseys (Jerseys appear immediately on first scroll) */}
      <FeaturedJerseys
      ...
      {/* 5. Main Catalog: Categories & Product Grid */}
