  ...
  return (
    <header 
      ...
      className={`sticky top-0 z-40 w-full transition-all duration-200 border-b ${
        isScrolled 
          ? 'bg-[#F7F6F2]/95 backdrop-blur-md border-[#E5E3DC] shadow-sm' 
          : 'bg-[#F7F6F2] border-[#EAE8E2]'
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs uppercase tracking-wider font-mono font-medium text-[#666660] hover:text-[#111111] py-1 transition-colors cursor-pointer border-b border-dashed border-[#BBB]"
              id="header-size-guide-btn"
            >
              <Ruler className="w-3.5 h-3.5 text-[#111111]" />
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              className="lg:hidden p-2 text-[#111111] hover:bg-[#EAE8E2] border border-[#E5E3DC] transition-colors"
              aria-label="Menu"
        ...
        <div className="lg:hidden bg-white border-b border-[#E5E3DC] px-6 py-6 space-y-4 animate-in slide-in-from-top-2 duration-150 shadow-lg">
          <div className="flex flex-col space-y-3">
            ...
            <button
              ...
              className="flex items-center gap-2 text-xs uppercase tracking-wider text-[#111111] py-2 text-left font-mono font-bold"
              id="mobile-size-guide-btn"
            >
              <Ruler className="w-4 h-4 text-[#111111]" />
              <span>Ver Tabela de Medidas (P ao XGG)</span>
            </button>
          </div>
          ...
          <div className="pt-4 border-t border-neutral-200 flex flex-col gap-2.5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-2.5 border border-neutral-300 text-xs font-bold uppercase tracking-wider text-[#111111] bg-white hover:bg-neutral-100 transition-colors"
            >
              <Instagram className="w-4 h-4" />
              <span>Seguir {storeConfig.instagramHandle}</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-3 bg-[#25D366] text-white font-extrabold text-xs uppercase tracking-wider shadow-sm"
            >
              <MessageCircle className="w-4 h-4 fill-white" />
              <span>Chamar no WhatsApp ({storeConfig.whatsappDisplay})</span>
            </a>
          </div>
        </div>
      )}
