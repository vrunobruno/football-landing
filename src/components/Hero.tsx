    ...
    <section className="relative overflow-hidden bg-[#F7F6F2] border-b border-[#EAE8E2] pt-8 sm:pt-14 pb-12 sm:pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <div className="w-full grid grid-cols-2 gap-4 pt-6 border-t border-[#EAE8E2] text-xs font-mono">
            <div><span className="text-[#888880] text-[10px] uppercase block tracking-wider">Tamanhos</span><span className="text-[#111111] font-semibold uppercase text-[11px] mt-0.5 block">P ao XGG</span></div>
            <div><span className="text-[#888880] text-[10px] uppercase block tracking-wider">Atendimento</span><span className="text-[#111111] font-semibold uppercase text-[11px] mt-0.5 block">WhatsApp</span></div>
          </div>
        </div>
